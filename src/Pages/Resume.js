...
export default function Resume() {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Anthony Linebaugh - Resume</title>
        <link rel="" href="https://ajlineb.github.io/React-Portfolio/resume" />
      </Helmet>
      <div className="info">
        ...
        <Row className="align-items-center ">
          <Col md="6" className="pdf-container">
            <object
              ...
              height={"1000px"}
            >
              Your web browser does not support a PDF plugin. Instead you can
              try clicking below to download my resume instead.
              <br></br>
